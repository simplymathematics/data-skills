...
For your own further analysis, we've exported each dataset as it's own table using SQL. 
...
con <- dbConnect(MySQL(), 
                 ...
                 dbname='data607_proj3', 

                 host='localhost')

dbReadTable(con, "characteristics")
dbReadTable(con, "indeed_keyword_count_ca")
dbReadTable(con, "indeed_keyword_count_ny")
dbReadTable(con, "salary")
dbReadTable(con, "techskills")
dbDisconnect(con)
```
